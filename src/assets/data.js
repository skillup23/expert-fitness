...
const slideExpert = [
  ...
  {
    id: id++,
    image: '/media/slideExpert5.png',
    title: 'Ерастова Галина Николаевна',
    subtitle:
      'Окончила Кубанский государственный университет физической культуры, спорта и туризма. Опыт работы в сфере фитнеса 15 лет. Широкий опыт преподавания курсов по подготовке инструкторов по фитнесу с 2010 г.',
    listText: [
      'Сертифицированный фитнес-тренер по программам Базовая/степ аэробика, Фитнес-йоге, системе Пилатес, Стрип-пластика',
      'Сертифицированный тренер по Theta Healing (Базовый уровень; Продвинутый; Манифестация изобилия)',
      'Мастер Рейки Микао Усуи',
      'Призёр Краевых соревнований по спортивной гимнастике, спортивно-бальным танцам',
      'Призер танцевальных конкурсов: "Русский Берег", Анапа, июнь, 2015. 3-е место. ART. Sport & dance games, Сочи, ноябрь,2015. 1-е место. Федерация Lady Style Dance России',
    ],
    listMobileText: [
      'Сертифицированный фитнес-тренер по программам Базовая/степ аэробика, Фитнес-йоге, системе Пилатес, Стрип-пластика',
      'Сертифицированный тренер по Theta Healing',
      'Мастер Рейки Микао Усуи',
      'Призёр Краевых соревнований по спортивной гимнастике, спортивно-бальным танцам',
    ],
  },
